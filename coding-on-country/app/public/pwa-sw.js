...
const BASE_CACHE_FILES = [
    'https://coding-on-country.local/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://coding-on-country.local/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://coding-on-country.local/',
];
...
const OFFLINE_PAGE = 'https://coding-on-country.local/';
const NOT_FOUND_PAGE = 'https://coding-on-country.local/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://coding-on-country.local//wp-admin/');
//    },
];
